...
Помимо прочего будет установлен [Parcel](https://parceljs.org/) — это упаковщик веб-приложений, похожий на [Webpack](https://webpack.js.org/).
...
В файл [`run_deploy.sh`](./run_deploy.sh) прописаны команды для обновлениея проекта на сервере.
Перед запуском файл необходимо сделать исполняемым:
